...
std::optional<juce::WebBrowserComponent::Resource> YTMSVisualizer::get_resource(const juce::String& url) {
    ...
    static struct {
        ...
        { "/modules/showcqt-element@2.2.0/audio-worklet.mjs", audioworklet_mjs, audioworklet_mjsSize, "text/javascript" },
        { "/modules/showcqt-element@2.2.0/axis-1920x32.png", axis1920x32_png, axis1920x32_pngSize, "image/png" },
        { "/modules/showcqt-element@2.2.0/extern-cdn.mjs", externcdn_mjs, externcdn_mjsSize, "text/javascript" },
        { "/modules/showcqt-element@2.2.0/extern.mjs", extern_mjs, extern_mjsSize, "text/javascript" },
        { "/modules/showcqt-element@2.2.0/showcqt-element-main.mjs", showcqtelementmain_mjs, showcqtelementmain_mjsSize, "text/javascript" },
